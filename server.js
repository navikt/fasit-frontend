...
app.get("/mockapi/v2/applicationinstances/environment/:environment", (req, res) => {
  sendJson(res, applicationinstances.findApplicationInstanceByEnv(req.params.environment))
})

app.get("/mockapi/v2/applicationinstances/application/:application", (req, res) => {
  sendJson(res, applicationinstances.findApplicationInstanceByApp(req.params.application))
})

app.get("/mockapi/v2/applicationinstances/1/revisions/69/appconfig", (req, res) => {
...
app.get("/mockapi/v2/environments/:name/clusters/:clustername/revisions", (req, res) => {
  sendJson(res, environmentsMock.getClusterRevisions())
})

app.get("/mockapi/v2/environments/:name/clusters/:clustername/revisions/:revision", (req, res) => {
