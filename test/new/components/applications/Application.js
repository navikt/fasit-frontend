...
describe('(Component) Application', () => {
    ...
    it('renders "Lifecycle" with props', () => {
        const wrapper = shallow(<Application {...props} application={{...props.application, lifecycle: {status: "rescued"}}}/>)
...
const props = {
    application: {
        ...
        lifecycle: {},
        links: {
            instances: "https://e34jbsl01655.devillo.no:8443/api/v2/applicationinstances?application=abac-eksempel-pep",
            revisions: "https://e34jbsl01655.devillo.no:8443/api/v2/applications/abac-eksempel-pep/revisions",
        ...
        data: [
            {
                ...
                authorid: "h141513",
                links: {
                    entity: "https://e34jbsl01655.devillo.no:8443/api/v2/applications/abac-eksempel-pep/revisions/2068148"
                },
                revision: "2068148",
                revisiontype: "add",
