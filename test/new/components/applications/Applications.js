...
describe("(Component) Applications", () => {
  ...
  it('renders "Application" and fetches correct data', () => {
    ...
    const wrapper = shallow(
      <Applications {...propsWithoutApplication} dispatch={dispatch} />
    );
  ...
  it('renders "Application" with loading animation if isFetching', () => {
    ...
    const wrapper = shallow(
      <Applications {...propsWithoutApplication} isFetching={true} />
    );
  ...
  it('renders "Application" and returns list of applications', () => {
    const wrapper = shallow(
      <Applications {...props} params={{ ...props.params, application: "" }} />
    );
...
const props = {
  ...
  applications: [
    ...
    },
    {
      ...
      links: {
        instances:
          "https://e34jbsl01655.devillo.no:8443/api/v2/applicationinstances?application=aareg-core",
        self:
          "https://e34jbsl01655.devillo.no:8443/api/v2/applications/aareg-core",
        revisions:
          "https://e34jbsl01655.devillo.no:8443/api/v2/applications/aareg-core/revisions",
      },
    },
    {
      ...
      links: {
        instances:
          "https://e34jbsl01655.devillo.no:8443/api/v2/applicationinstances?application=aareg-mldpusher",
        self:
          "https://e34jbsl01655.devillo.no:8443/api/v2/applications/aareg-mldpusher",
        revisions:
          "https://e34jbsl01655.devillo.no:8443/api/v2/applications/aareg-mldpusher/revisions",
      },
    },
  ],
  totalCount: "3",
