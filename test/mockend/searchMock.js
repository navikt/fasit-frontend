module.exports = {
  getSearch: (queryParams) =>
    search.filter((result) =>
      queryParams.type ? result.type === queryParams.type : true
    ),
};
