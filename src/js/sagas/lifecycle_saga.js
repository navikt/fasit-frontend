  ...
  try {
    ...
    switch (action.elementType) {
      ...
      case "cluster":
        ...
        break
      case "environment":
        const currentEnvironment = yield select(
          state => state.environment_fasit
        )
      ...
      case "applicationinstance":
        const currentApplicationInstance = yield select(
          state => state.instance_fasit
        )
