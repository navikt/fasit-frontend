...
class NodeFasitViewSubmitDeleteStatus extends Component {
    ...
    closeSubmitForm() {
        ...
        dispatch(closeSubmitDeleteNodeStatus())
        dispatch(showDeleteNodeForm(false))
    }
...
NodeFasitViewSubmitDeleteStatus.propTypes = {
    dispatch: PropTypes.func.isRequired
}

const mapStateToProps = (state) => {
    return {
        form: state.node_deleteNode,
    }
}

export default connect(mapStateToProps)(NodeFasitViewSubmitDeleteStatus)
