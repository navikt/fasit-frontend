        ...
        return (
                <div className="element-list-paging">
                    ...
                    <div className="btn-group btn-group-justified">
                        <a className="btn btn-link " onClick={toFirstPage}><i className="fa fa-angle-double-left" aria-hidden="true" /></a>
                        ...
                        <a className="btn btn-link " onClick={toLastPage}><i className="fa fa-angle-double-right" aria-hidden="true" /></a>
                    </div>
                </div>
        )
